...
//// 位姿
//
//@Autonomous(name = "AAA RED Far Twelve HumanPlayers HumanPlayers V1 Red9short")
////three preload and take home twice and one first role, parking
//
//public class AAARed12farTurretHumanPlayersONLY extends LinearOpMode {
...
//    private final Pose readyFirstHomePickupPose = new Pose(100, 8.25, Math.toRadians(0));//129, 22.25
//    private final Pose readyFirstHomePickupPoseSecondTry = new Pose(113, 11.25, Math.toRadians(0));// 5+
//    private final Pose readySecondHomePickupPose = new Pose(113, 8.25, Math.toRadians(0));
//    private final Pose readySecondHomePickupPoseSecondTry = new Pose(113, 11.25, Math.toRadians(0));
//    private final Pose readyThirdHomePickupPose = new Pose(113, 8.25, Math.toRadians(0));
//    private final Pose readyThirdHomePickupPoseSecondTry = new Pose(113, 11.25, Math.toRadians(0));
...
//                if (!firstHomePickupSecondTryCompleted && pathTimer.getElapsedTimeSeconds() < 1.8) {
//                    autoIntake();
//                } else {
...
//                if (!secondHomePickupSecondTryCompleted && pathTimer.getElapsedTimeSeconds() < 1.8) {
//                    autoIntake();
//                } else {
...
//                if (!thirdHomePickupSecondTryCompleted && pathTimer.getElapsedTimeSeconds() < 1.8) {
//                    autoIntake();
//                } else {

...
//            robot.BlockageArm.setPosition(blockageblockTele);
    ...
    public static class ShooterPIDFConfig {
        ...
        public static double kF = 14;      // 15.1 V=1160
        //To tune the feedforward controller, increase the velocity feedforward gain until the flywheel approaches the correct setpoint over time. If the flywheel overshoots, reduce .
        //Set , , , and to zero.
        //
...
//        telemetry.addData("kI", "%.4f", ShooterPIDFConfig.kI);
        ...
        telemetry.addData("PIDFTimer.seconds()", "%.0f RPM", PIDFTimer.seconds());
//
//        // 从电机状态

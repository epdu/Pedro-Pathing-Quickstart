...
//// 位姿
//
//@Autonomous(name = "RED Far THREE preload + home without turret V1 Red9short")
////three preload and take two roles, parking
////shooting a little bit too long
////6 s left over
////parking further
//public class Red3farwithoutTurret extends LinearOpMode {
...
//    private PathChain driveStartInter;
//    private PathChain driveInterShoot;
//    private PathChain driveReadyHomeFirstPickup, driveHomeFirstPickup,driveHomeFirstPickupShoot;
//    private PathChain driveReadyHomeSecondPickup,driveHomeSecondPickup, driveHomeSecondPickupShoot;
//    private PathChain driveReadyHomeThirdPickup, driveHomeThirdPickup, driveHomeThirdPickupShoot;
//    private PathChain driveOffline;
//
//    public enum PathState {
//        DRIVE_START_POS_INTER_POS,
//        DRIVE_INTER_POS_SHOOT_POS,
//        DRIVE_TO_SHOOT_WAIT,
//        SHOOT_PRELOAD,
//        DRIVE_READY_HOME_PICKUP_POS,
//        HOME_PICKUP,
//        DRIVE_BACK_HOME_SHOOT_POS,
//        SHOOT_HOME_PICKUP,
...
//    private final Pose interPose = new Pose(96,12.25, Math.toRadians(0)); // Start Pose further zone of our robot.
...
//    private final Pose readyHomePickupPose = new Pose(120, 6.45, Math.toRadians(0)); // PPG  Highest (First Set) of Artifacts from the Spike Mark.
//    private final Pose homePickupPose = new Pose(144, 6.45, Math.toRadians(0)); // PGP Middle (Second Set) of Artifacts from the Spike Mark.
...
//
////    private final Pose readyHomePickupPose = new Pose(92, 62.25, Math.toRadians(0)); // PGP Middle (Second Set) of Artifacts from the Spike Mark.
////    private final Pose readyHomePickupPose = new Pose(92, 37.25, Math.toRadians(0)); // GPP Lowest (Third Set) of Artifacts from the Spike Mark.
...
////    private final Pose thirdPickupPose = new Pose(134, 37.25, Math.toRadians(0)); // GPP Lowest (Third Set) of Artifacts from the Spike Mark.
...
//
//        pathState = PathState.DRIVE_START_POS_INTER_POS;
...
////                .addPath(new BezierLine(readyThirdPickupPose, thirdPickupPose))
...
//        switch (pathState) {
//            case DRIVE_START_POS_INTER_POS:
//                follower.followPath(driveStartInter, 0.3, true);
//                setPathState(PathState.DRIVE_INTER_POS_SHOOT_POS);
//                break;
//            case DRIVE_INTER_POS_SHOOT_POS:
//                follower.followPath(driveInterShoot, 0.3, true);
...
//                   isShooterAtSpeed = false;
//                   setPathState(PathState.DRIVE_READY_HOME_PICKUP_POS);
//                    }
//               break;
//
//
//            case DRIVE_READY_HOME_PICKUP_POS:
//                if (!follower.isBusy()) {
//                    follower.followPath(driveFirstPickup, 0.5, true);
//                    setPathState(PathState.HOME_PICKUP);
//                }
//                break;
//            case HOME_PICKUP:
...
//                    stopShooter();
//                    stopIntake();
//                    setPathState(PathState.DRIVE_BACK_HOME_SHOOT_POS);
//                    firstPickupCompleted = true;
//                }
//                break;
//            case DRIVE_BACK_HOME_SHOOT_POS:
//                if (!follower.isBusy()) {
//                    setPathState(PathState.SHOOT_HOME_PICKUP);
//                    autoShootState = AutoShootState.IDLE;
//                }
//                break;
//            case SHOOT_HOME_PICKUP:
//                autoshoot();
//                if (autoShootState == AutoShootState.DONE) {

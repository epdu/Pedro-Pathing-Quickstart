...
//    private final Pose GPPPose = new Pose(100, 35.5, Math.toRadians(0)); // GPP Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose scoreEnd = new Pose(96, 95, Math.toRadians(0)); // Scoring Pose of our robot. It is facing the goal at a 115 degree angle.
    private final Pose readyPickupPosePPG = new Pose(96, 82.25, Math.toRadians(0)); // PPG  Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose PPGPose = new Pose(100, 82.25, Math.toRadians(0)); // PPG  Highest (First Set) of Artifacts from the Spike Mark.

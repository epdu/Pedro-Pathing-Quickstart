...
public class RTPAxonRev {
    ...
    public RTPAxonRev(CRServo servo, DcMotorEx encoder) {
        rtp = true;
        this.servo = servo;
    ...
    public RTPAxonRev(CRServo servo, DcMotorEx encoder, Direction direction) {
        this(servo, encoder);
    ...
    public double getCurrentAngle() {
        ...
        return (servoEncoder.getCurrentPosition()/40726.0) * (direction.equals(Direction.REVERSE) ? -360 : 360);
    }
    ...
    public static class CRAxonTestRev extends LinearOpMode {
        ...
        public void runOpMode() throws InterruptedException {
            ...
            RTPAxonRev servo = new RTPAxonRev(crservo, encoder);

...
//// Limelight
//// 位姿
//@Autonomous(name = "RED Near opengate & intake TWELVE  without turret V1 Red9short")
...
//    private final Pose openGatePickupPose = new Pose(133, 60, Math.toRadians(50));  //63--61
...
//
//            case FEEDING:
//                if (shootTimer.getElapsedTimeSeconds()  >= 1.15) {
//                    stopShooter();
//                    stopIntake();
////                    robot.BlockageArm.setPosition(blockageblockposition); //switch with blockage case with blockage

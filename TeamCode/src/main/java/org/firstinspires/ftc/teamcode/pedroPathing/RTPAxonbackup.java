...
//    public RTPAxonbackup(CRServo servo, AnalogInput encoder) {
//        rtp = true;
//        this.servo = servo;
...
//    public RTPAxonbackup(CRServo servo, AnalogInput encoder, Direction direction) {
//        this(servo, encoder);
...
//            RTPAxonbackup servo = new RTPAxonbackup(crservo, encoder);
//
//            waitForStart();
//

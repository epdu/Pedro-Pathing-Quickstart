...
//    public RTPAxoncopy(CRServo servo, AnalogInput encoder) {
//        rtp = true;
//        this.servo = servo;
...
//    public RTPAxoncopy(CRServo servo, AnalogInput encoder, Direction direction) {
//        this(servo, encoder);
...
//            RTPAxoncopy servo = new RTPAxoncopy(crservo, encoder);
//
//            waitForStart();
//

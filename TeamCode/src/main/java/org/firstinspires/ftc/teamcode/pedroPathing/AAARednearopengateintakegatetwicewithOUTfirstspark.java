...
// Limelight
// 位姿
@Autonomous(name = "AAA RED Near open Gate WITH gate intake twice second spark,third spark withOUT firstspark intake 03092026 V1")
...
//    IntakeSubsystem intakeSubsystem;
    ...
    public enum PathState {
        ...
        SECOND_SPIKE_PICKUP,
        DRIVE_READY_OPEN_GATE_POS,/// //no intake
        OPEN_GATE,
        DRIVE_BACK_SECOND_SPIKE_PICKUPT_POS,
        SHOOT_SECOND_SPIKE_PICKUP,
        DRIVE_READY_FIRST_OPEN_GATE_POS,// intake
        FIRST_OPEN_GATE,
